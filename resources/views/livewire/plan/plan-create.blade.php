<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createPlan" class="w-full max-w-7xl mx-auto">
        <div class="flex flex-wrap -mx-3 mb-6 mt-4">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase border @error('plan.slug') border-red-500 @else border-gray-200 @enderror  tracking-wide text-gray-700 text-xs font-bold mb-2">Apelido Plano</label>
