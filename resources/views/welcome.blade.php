...
<div class="relative bg-white overflow-hidden">
                ...
                <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                    <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            ...
                            <a href="{{route('login')}}" class="font-medium text-indigo-600 hover:text-indigo-500">Log
                                in</a>
                        </div>
                    </nav>
                </div>
                ...
                <div class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                    <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        ...
                        <div class="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <a href="#"
                               class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">O
                                Que Oferecemos</a>


                            <a href="#"
                               class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Sobre
                                Nós</a>

                            <a href="#"
                               class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Fale
                                Conosco</a>
                        </div>
                        <a href="{{route('login')}}"
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
             src="https://images.unsplash.com/photo-1593538312308-d4c29d8dc7f1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
             alt="">
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto pt-20">
        ...
        <div class="w-full flex justify-between  py-20">
            ...
            <div class="w-96 text-left py-20 px-10 border border-gray-300 rounded">
                ...
                <h3 class="font-extrabold text-3xl mb-20">R$ {{number_format($plan->price / 100, 2, ',', '.')}} <small
                        class="font-normal">/ mês</small></h3>
