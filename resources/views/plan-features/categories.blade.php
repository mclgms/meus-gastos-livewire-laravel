<div class="w-full px-3 mb-6 md:mb-0">
    ...
    <select id="categories" wire:model="categories"
            class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" multiple>
